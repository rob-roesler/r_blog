...
```{r echo = TRUE, message = FALSE, warning = FALSE, results = "hide", fig.height=5, fig.width=8}
require(ggplot2)
require(cluster)
require(reshape)
...
```{r echo = TRUE, message = FALSE, warning = FALSE, results = "markup", fig.height=5, fig.width=8}
#-------------------------------
# Plot results
#-------------------------------
# Aggregation dataset
...
```{r echo = TRUE, message = FALSE, warning = FALSE, results = "markup", fig.height=25, fig.width=40}
#-------------------------------
